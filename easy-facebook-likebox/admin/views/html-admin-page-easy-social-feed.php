...
$fta_all_plugs = $Feed_Them_All->fta_plugins();
			  ...
			  <div class="box"></div>
				...
				<div class="fta_tab_c_holder">
						...
						<div class="fta_all_plugs col s12">
							...
							<?php
							// YouTube module card.
							$status = $Feed_Them_All->module_status( 'youtube' );
							...
							?>
							<div class="card col fta_single_plug s5 fta_plug_youtube   fta_plug_<?php esc_attr_e( $status ); ?>">

								<div class="card-content">
									<span class="card-title  grey-text text-darken-4">
										<?php esc_html_e( 'YouTube Feed', 'easy-facebook-likebox' ); ?>
									</span>
								</div>
								<hr>
								<div class="fta_cta_holder">
									...
									<ul>
										<li>
											<?php esc_html_e( 'Latest videos from your YouTube channel', 'easy-facebook-likebox' ); ?>
										</li>
										<li>
											<?php esc_html_e( 'Secure OAuth 2.0 connection (no API key required)', 'easy-facebook-likebox' ); ?>
										</li>
										<li>
